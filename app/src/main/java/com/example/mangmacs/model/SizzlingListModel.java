...
public class SizzlingListModel {
    ...
    public SizzlingListModel(String productName, String productVariation, String status, String image, int price, String codeSeafoods){
